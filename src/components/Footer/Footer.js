    ...
    <footer className='footer'>
      <Container>
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <h5 className='footer__title'>Contacts</h5>
            <ListGroup className='deliver__time-list'>
              <ListGroupItem className='delivery__time-item border-0 ps-0'>
                <p>Location: NaKoja Abad</p>
                
              </ListGroupItem>
              <ListGroupItem className='delivery__time-item border-0 ps-0'>
                <span>Phone: 099999999</span>
        ...
        <Row className='mt-5'>
          <Col lg="6" md="6">
            <p className='copyright__text'>CopyRight - 2023, webSite mohammad. All Right reserved.</p>
          </Col>
          <Col lg="6" md="6">
